...
f_test_result
```
*Hay evidencia significativa de que la varianza de la serie temporal de 'energía' varía tras la interpolación. Este cambio podría influir en un modelo de regresión lineal múltiple destinado a predecir la energía utilizando múltiples variables. Por tanto, se compararán los modelos de regresión lineal múltiple, tanto con los datos originales como con los interpolados, para evaluar el impacto de la variabilidad en la varianza.*

### Análisis y Ajuste de Datos Interpolados para la Regresión Lineal Múltiple
*Se analizará la regresión sobre los datos interpolados, que son de interés para el proyecto. Tras este análisis, se harán ajustes correspondientes en ambos conjuntos de datos (interpolados y no interpolados), con el objetivo de calcular la regresión lineal múltiple definitiva de la variable energía*
