...
Es esencial asegurar que la interpolación no haya sesgado significativamente la media o la varianza.
...
Las notables variaciones en la serie de tiempo podrían resultar en interpretaciones incorrectas de las tendencias, impactando las proyecciones sobre el consumo. Por esta razón, se efectuarán comparaciones de las medias entre ambos conjuntos de datos para asegurar la precisión en el análisis.
