...
Los archivos 'junio2022_minuto_sin_interpolación.csv' y 'junio2022_minuto_con_interpolación.csv' contienen datos de mediciones clasificados en dos categorías: *variables energéticas* y *variables de rendimiento*. El archivo 'junio2022_minuto_sin_interpolación.csv' presenta la data original, con datos faltantes. Por otro lado, el archivo 'junio2022_minuto_con_interpolación.csv' contiene los mismos datos, pero después de haber aplicado la técnica de interpolación para completar los valores faltantes.  \n: 
